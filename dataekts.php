		            	...
		            	<div class="x_content">
		                    <div class="bs-example" data-example-id="simple-jumbotron">
		                        <div class="jumbotron" style="text-align:center; color:black;">
		                            <h2>BUKAN PERIODE MELENGKAPI EKTS</h2>
		                        </div>
		                    </div>
		                </div>
						...
						?>
									<div class="right_col" role="main">
						            	<div class="x_content">
						                    <div class="bs-example" data-example-id="simple-jumbotron">
						                        <div class="jumbotron" style="text-align:center; color:black;">
						                            <h2>Lengkapi data EKTS (Evaluasi Kinerja Tridharma Semester)</h2>
						                        </div>
						                    </div>
						                </div>
						                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
											...
											<tr>
												...
												<th width="40" >Lengkapi</th>
												<th width="40" >Download Verifikasi EKTS</th>
											</tr>
										</thead>
										...
										<tbody>
												...
												<tr class="gradeA">
													...
													<td>
														...
														<a style="color:white;" href="ekts.php?semester=<?php echo $row['semester'];?>&tahun_ajaran=<?php echo $row['tahun_ajaran'];?>&nik=<?php echo $row['nik'];?>">Lengkapi</a>
														</div>
													</td>
													<td>
														<div class="btn btn-info">
														<a style="color:white;" href="admin/pdf/examples/verifikasi_ekts.php?semester=<?php echo $row['semester'];?>&tahun_ajaran=<?php echo $row['tahun_ajaran'];?>&nik=<?php echo $row['nik'];?>" target="_blank">Download</a>
														</div>
													</td>
												</tr>
												<?php
