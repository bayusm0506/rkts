            ...
            <div class="right_col" role="main">
				...
				?>
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<center><button type="button" class="btn btn-danger btn-lg">BUKAN PERIODE PENGISIAN RKTS</button>
							</div>
						</div>
                <?php
						}
							...
							?>
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
										<div class="x_panel">
											<center><button type="button" class="btn btn-danger btn-lg">BATAS WAKTU PENGISIAN RKTS <?php echo TanggalIndo($batas_awal); ?> Sampai <?php echo TanggalIndo($batas_akhir); ?></button>
										</div>
									</div>
								<div class="">
																	...
																	<thead>
																			...
																			<tr>
																				...
																				<ol style="list-style-type: lower-alpha; font-size: 11px;">
																					...
																					<li>Rencana Pembelajaran Semester (RPS)</li>
																				</ol>
																				</td>
																			...
																			<tr>
																				...
																				<ol style="list-style-type: lower-alpha; font-size: 11px;">
																					...
																					<li>Kepala Laboratorium / Pelaksana Laboratorium</li>
																				</ol>
																				</td>
