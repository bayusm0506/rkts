                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
													...
													<div class="item form-group">
                                                        ...
                                                        <?php
                                                            if($row['photo']!=""){
                                                                ?>
                                                                    <img src="admin/upload/<?php echo $row['photo'];?>" style="width:80px; height:100px;"> </td>
                                                                <?php
                                                            }
                                                            else{
                                                                ?>
                                                                    <img src="admin/upload/undefined.jpg" style="width:80px; height:100px;"> </td>
                                                                <?php
                                                            }
                                                        ?>
                                                        <form action="process.php?act=uploadphoto" method="post" enctype="multipart/form-data">
                                                            <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="" data-validate-words="" name="id_user" required="required" type="hidden" value="<?php echo $row['id_user'];?>">
