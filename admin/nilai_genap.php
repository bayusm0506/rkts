            ...
            <div class="right_col" role="main">
            	<div class="x_content">
					<div class="bs-example" data-example-id="simple-jumbotron">
                        <div class="jumbotron" style="text-align:center; color:black;">
                            <h2>SKORING RKTS DAN EKTS DOSEN SEMESTER GENAP</h2>
                        </div>
                    </div>
                </div>
				...
				<tbody>
						<?php
							...
							$no = 1;
							$view=mysql_query("SELECT * FROM tbl_user, tbl_rencana, tbl_berkas WHERE tbl_user.nik = tbl_rencana.nik AND tbl_user.nik = tbl_berkas.berkas_nik AND tbl_rencana.semester = tbl_berkas.berkas_semester AND tbl_rencana.tahun_ajaran = tbl_berkas.berkas_tahun_ajaran AND tbl_rencana.koreksi = tbl_berkas.koreksi AND tbl_rencana.koreksi = 'Sudah' AND tbl_berkas.koreksi='Sudah' AND tbl_user.fakultas='$fakultas' AND tbl_rencana.semester='Genap' ORDER BY tbl_rencana.tahun_ajaran DESC");
				...
				<tbody>
						<?php
							...
							$fakultas = $_SESSION['fakultas']; 
							$no = 1;
							$view=mysql_query("SELECT * FROM tbl_user, tbl_rencana WHERE tbl_user.nik = tbl_rencana.nik AND tbl_rencana.koreksi='Sudah' AND tbl_rencana.semester='Genap' ORDER BY tbl_rencana.tahun_ajaran DESC, tbl_user.fakultas ASC");
							while($row=mysql_fetch_array($view)){
						?>
						<tr class="gradeA">
							<td><?php echo $no;?></td>
