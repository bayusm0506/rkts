            ...
            <div class="right_col" role="main">
				...
				<tbody>
						<?php
							include "config.php";
							$no = 1;
							$view=mysql_query("SELECT * FROM tbl_user, tbl_rencana, tbl_berkas WHERE tbl_user.nik = tbl_rencana.nik AND tbl_user.nik = tbl_berkas.berkas_nik AND tbl_rencana.semester = tbl_berkas.berkas_semester AND tbl_rencana.tahun_ajaran = tbl_berkas.berkas_tahun_ajaran AND tbl_rencana.koreksi = tbl_berkas.koreksi AND tbl_rencana.koreksi = 'Sudah' AND tbl_berkas.koreksi='Sudah'");
