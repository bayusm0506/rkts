            ...
            <div class="right_col" role="main">
            	<div class="x_content">
                    <div class="bs-example" data-example-id="simple-jumbotron">
                        <div class="jumbotron">
                            <h2>Skoring RKTS dan EKTS Dosen</h2>
                        </div>
                    </div>
                </div>
				...
				<tbody>
						<?php
							...
							$no = 1;
							$view=mysql_query("SELECT * FROM tbl_user, tbl_rencana, tbl_berkas WHERE tbl_user.nik = tbl_rencana.nik AND tbl_user.nik = tbl_berkas.berkas_nik AND tbl_rencana.semester = tbl_berkas.berkas_semester AND tbl_rencana.tahun_ajaran = tbl_berkas.berkas_tahun_ajaran AND tbl_rencana.koreksi = tbl_berkas.koreksi AND tbl_rencana.koreksi = 'Sudah' AND tbl_berkas.koreksi='Sudah' AND tbl_user.fakultas='$fakultas'");
						...
						<tr class="gradeA">
							...
							<td><a href="pdf/examples/rekap.php?nik=<?php echo $row[nik];?>&semester=<?php echo $row[semester];?>&tahun_ajaran=<?php echo $row[tahun_ajaran];?>" target="_blank">LIHAT NILAI</a></td>
							<td>Edit Nilai</td>
						</tr>
						<?php
							$no++;
