...
<!-- page content -->
			...
			<p><b>SETTING BATAS WAKTU NILAI</b></p>
				<form action="process.php?act=batas_nilai" method="post">
						<div style="background:; float:left;	">
							<div class="item form-group">
							<?php
								$view=mysql_query("select * from tbl_hasil_skor");
							...
							<div style="display: inline-block;">
													...
													<input id="name" class="form-control col-md-7 col-xs-12"  name="id_hasil" placeholder="" type="hidden" readonly="" value="<?php echo $row['id_hasil'];?>">
