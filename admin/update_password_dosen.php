                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
								...
								<form action="process.php?act=updatepassword_dosen" method="post">
									<div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
													...
													<div class="item form-group">
														<input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="" data-validate-words="" name="id_user" required="required" type="hidden" value="<?php echo $_GET['id'];?>">
