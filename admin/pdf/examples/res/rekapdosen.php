...
<span style="font-size: 20px; font-weight: bold">Rekap Data Dosen Universitas Medan Area<br></span>
<br>
<br>
<table width="100%">
    <thead>
        <tr>
            ...
            <th colspan="9" style="font-size: 16px;">
                Daftar Dosen Universitas Medan Area
            </th>
        </tr>
        <tr>
            <th>NIDN</th>
            <th style="width:100px;">NAMA</th>
            <th style="width:45px;">JENIS KELAMIN</th>
            <th>TANGGAL LAHIR</th>
            <th>PROGRAM STUDI</th>
            <th>PENDIDIKAN</th>
            <th>STATUS</th>
...
<?php
    ...
    $view=mysql_query("select * from tbl_pegawai_dosen WHERE level_user='3' AND kd_approve='1'");
    $no=1;
    while($row=mysql_fetch_array($view)){
?>
    <tr>
        <td><?php echo $no; ?></td>
        <td><?php echo $row['nidn_nupn'];?></td>
        ...
        <td><?php echo $row['jab_akademik'];?></td>
        <td><?php echo $row['instansi_asal'];?></td>
    </tr>
<?php
    $no=$no+1;
    }
