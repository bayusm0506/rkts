...
<page backtop="10mm" backbottom="10mm" backleft="20mm" backright="20mm">
    ...
    <div class="clrs"></div>
    <div style="margin-top:-10px; margin-right:60px; padding-bottom:10px; text-align:center;">DATA PEGAWAI</div>
    <br>
    <div>
    ...
    <table style="width: 80%; border:1px solid red; margin-top:-40px;">
        <thead>
            ...
            <tr>
                <td style="width: 40%; text-align: left;">TMT Kerja </td>
                <td>:</td>
                <td style="width: 40%; text-align: left;"> <?php echo TanggalIndo($row['tmt_kerja']);?></td>
            </tr>
            <tr>
                <td style="width: 40%; text-align: left;">Golongan </td>
                <td>:</td>
                <td style="width: 40%; text-align: left;"> <?php echo $row['gol'];?></td>
            </tr>
            <tr>
                <td style="width: 40%; text-align: left;">TMT Golongan </td>
                <td>:</td>
                <td style="width: 40%; text-align: left;"> <?php echo $row['tmt_golongan'];?></td>
            </tr>
            <tr>
                <td style="width: 40%; text-align: left;">Unit Kerja </td>
                <td>:</td>
                <td style="width: 40%; text-align: left;"> <?php echo $row['unit_kerja'];?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 40%; text-align: left;">Sertifikat </td>
                <td>:</td>
                <td style="width: 40%; text-align: left;"> <?php echo $row['sertifikat'];?></td>
            </tr>
            <tr>
                <td style="width: 40%; text-align: left;">Prestasi </td>
                <td>:</td>
                <td style="width: 40%; text-align: left;"> <?php echo $row['prestasi'];?></td>
            </tr>
