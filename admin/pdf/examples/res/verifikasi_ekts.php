...
<page style="font-size: 10pt;">
    ...
    <br>
    <br>
    <i><span style="font-size: 10pt; font-weight: bold; text-align: justify;">Bahwa Saya telah mengisi laporan EKTS (Evaluasi Kinerja Tridharma Semester) ini menyatakan bahwa aktivitas dan bukti pendukungnya adalah benar aktivitas saya dan saya sanggup menerima sanksi apapun termasuk penghentian tunjangan dan mengembalikan yang sudah saya terima apabila pernyataan ini dikemudian hari terbukti tidak benar.</span></i>
    <br>
    <br>
    <br>
    <br>
    ...
    <br>
    <br>
    <i><div class="senter2" style="font-size: 9pt; text-align: justify;">Saya sudah memeriksa kebenaran dokumen yang ditunjukkan dan bisa menyetujui laporan EKTS ini.</div></i>
    <br>
    <br>
