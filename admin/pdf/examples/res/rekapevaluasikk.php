...
<table width="100%">
    <thead>
        <tr>
            <th colspan="7" style="background:red;">DATA PENILAIAN K2AP <?php $tanggal = date("Y-m-d"); ?><?php echo TanggalIndo($tanggal); ?></th>
        </tr>
        <tr>
            <th>No</th>
            <th>NAMA</th>
            <th style="width:130px; font-size:10px; text-align:center;">UNIT KERJA</th>
            <th style="width:75px; font-size:10px; text-align:center;">STATUS KERJA</th>
            <th colspan="2" style="width:100px; font-size:10px; text-align:center;">HASIL EVALUASI K2AP TINGKAT UNIVERSITAS</th>
            <th style="width:135px; font-size:10px; text-align:center;">PENANGGUNG JAWAB K2AP</th>
        </tr>
    </thead>
    <?php
...
<?php
    ...
    $view=mysql_query("SELECT *
                        FROM tbl_hasilnilaikk WHERE MONTH(tgl_buat) = MONTH(CURRENT_DATE)");
    $no=1;
...
?>
    <tbody>
        <tr>
            ...
            <td style="width:130px; font-size:10px; text-align:center;"><?php echo $row['unitkerja'];?></td>
            ...
            <td style="width:135px; font-size:10px; text-align:center;"><?php echo $row['pimpinan'];?></td>
        </tr>
    </tbody>
...
?>
    <tfoot>
        <tr>
            <th colspan="7" style="font-size: 10px;">
