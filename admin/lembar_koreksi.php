									...
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="x_panel">
												...
												<form action="process.php?act=input_nilai" method="post">
												...
												<div class="x_content">
														...
														<div class="form-horizontal form-label-left" novalidate>
															...
															<p>
																Contoh pengisian nilai : <br />
																1. Skor pertama : 60 <br />
																2. Skor kedua : 60.5 <br />
																Jika skor tersebut mempunyai bilangan berkoma maka tambahkan tanda titik (.), tidak dibenarkan mamasukkan tanda koma(,)
															</p>
														</div>  
												<!-- end form lebar -- >
												<!--inbetween-->
											...
											<div class="row">                                
												<div class="col-md-12 col-sm-12 col-xs-12">
													<div class="x_panel">
												<div class="x_title">
													<h2><i class="fa fa-bars"></i> EKTS Koreksi </h2>
													<div class="clearfix"></div>
												</div>
												<div class="x_content">
																...
																<table class="table table-bordered">
																	<thead>
																			...
																			<tr>
																				...
																				<td><input type="text" name="koreksi1"></td>
																			</tr>
																		</thead>
																</table>
																...
																<table class="table table-bordered">
																	<thead>
																		...
																		<tr>
																			...
																			<td><input type="text" name="koreksi2"></td>
																		</tr>
																		<!--  atas  -->
																		<tr>
																			<td>2.</td>
																			...
																			<td><input type="text" name="koreksi3"></td>
																		</tr>
																		...
																		<tr>
																			...
																			<td><input type="text" name="koreksi4"></td>
																		</tr>
																		...
																		<tr>
																			...
																			<td>
																				<?php
																					...
																					?>
																			</td><td><input type="text" name="koreksi5"></td>
																		</tr>
																		<tr>
																			<td>5</td>
																					<td style="width:500px;">
																			...
																			<td>
																				<?php
																					...
																					?>
																			</td><td><input type="text" name="koreksi6"></td>
																		</tr>
																		<tr>
																			<td>6</td>
																				<td style="width:500px;">
																			...
																			<td>
																				<?php
																					...
																					?>
																			</td><td><input type="text" name="koreksi7"></td>
																		</tr>
																	</thead>
																</table>
																<table class="table table-bordered">
																	<thead>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi8"></td>
																			</tr>
																		</thead>
																</table>
																	...
																	<thead>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi9"></td>
																			</tr>
																		</thead>
																</table>
																	...
																	?>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi10"></td>
																			</tr>
																			<tr style="background:#EEE;">
																				<th >2.</th>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi11"></td>
																			</tr>
																		</thead>
																</table>
																	...
																	<thead>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi12"></td>
																			</tr>
																			<tr style="background:#EEE;">
																				<th >2.</th>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi13"></td>
																			</tr>
																		</thead>
																</table>
																	...
																	<thead>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi14"></td>
																			</tr>
																		</thead>
																</table>
																	...
																	<thead>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi15"></td>
																			</tr>
																			<tr>
																				<td>2.</td>
																				<td style="width:500px;">
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi16"></td>
																			</tr>
																		</thead>
																</table>
																	...
																	<thead>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi17"></td>
																			</tr>
																			<tr>
																				<td>2.</td>
																				<td>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi18"></td>
																			</tr>
																			<tr>
																				<td>3.</td>
																				<td>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi19"></td>
																			</tr>
																			<tr style="background:#EEE;">
																				<th>No.</th>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi20"></td>
																			</tr>
																			<!-- bawah -->
																			<!-- atas -->
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi21"></td>
																			</tr>
																			<!-- bawah -->
																				<!-- atas -->
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi22"></td>
																			</tr>
																			<!-- bawah -->
																			<tr style="background:#EEE;">
																				<th>No.</th>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi23"></td>
																			</tr>
																		</thead>
																</table>
																	...
																	<thead>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi24"></td>
																			</tr>
																			<tr>
																				<td>2.</td>
																				<td style="width:500px;">
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi25"></td>
																			</tr>
																			<tr>
																				<td>3.</td>
																				<td style="width:500px;">
																				...
																				<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi26"></td>
																			</tr>
																		</thead>
																</table>
																...
																<table class="table table-bordered">
																	<thead>
																			...
																			<tr>
																				...
																				<td><input type="text" name="koreksi27"></td>
																			</tr>
																			<tr>
																				<td>2.</td>
																					<td style="width:500px;">
																				...
																				<td><input type="text" name="koreksi28"></td>
																			</tr>
																		</thead>
																</table>
																...
																<table class="table table-bordered">
																	<thead>
																			...
																			<tr>
																				...
																				<td><input type="text" name="koreksi29"></td>
																			</tr>
																			<tr>
																				<td>2.</td>
																				<td style="width:500px;">
																				...
																				<td><input type="text" name="koreksi30"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																				<th >No.</th>
																			...
																			<tr>
																				...
																				<td><input type="text" name="koreksi31"></td>
																			</tr>
																			<tr>
																				<td>2.</td>
																				<td style="width:500px;">
																				...
																				<td><input type="text" name="koreksi32"></td>
																			</tr>
																		</thead>
																</table>
																...
																<table class="table table-bordered">
																	<thead>
																			...
																			<tr>
																				...
																				<td><input type="text" name="koreksi33"></td>
																			</tr>
																			<tr>
																				<td>2.</td>
																				<td style="width:500px;">
																				...
																				<td><input type="text" name="koreksi34"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																				<th >No.</th>
																			...
																			<tr>
																				...
																				<td>
																					...
																					?>
																					<td><input type="text" name="koreksi35"></td>>
																				</td>
																			</tr>
																			<tr>
																				<td>2.</td>
																				...
																				<td><input type="text" name="koreksi36"></td>
																			</tr>
																		</thead>
																</table>
																...
																<table class="table table-bordered">
																	<thead>
																			...
																			<tr>
																				...
																				<td><input type="text" name="koreksi37"></td>
																			</tr>
																			<tr>
																				<td>2</td>
																				<td style="width:500px;">
																				...
																				<td><input type="text" name="koreksi38"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																				<th rowspan="2">No.</th>
																			...
																			<tr>
																				...
																				<td><input type="text" name="koreksi39"></td>
																			</tr>
																			<tr>
																				<td>2</td>
																				<td style="width:500px;">
																				...
																				<td><input type="text" name="koreksi40"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																				<th rowspan="2">No.</th>
																			...
																			<tr>
																				...
																				<td><input type="text" name="koreksi41"></td>
																			</tr>
																			<tr>
																				<td>2</td>
																					<td style="width:500px;">
																				...
																				<td><input type="text" name="koreksi42"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																				<th rowspan="2">No.</th>
																			...
																			<tr>
																				...
																				<td><input type="text" name="koreksi43"></td>
																			</tr>
																			<tr>
																				<td>2</td>
																					<td style="width:500px;">
																				...
																				<td><input type="text" name="koreksi44"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																				<th rowspan="2">No.</th>
																			...
																			<tr>
																				...
																				<td><input type="text" name="koreksi45"></td>
																			</tr>
																			<tr>
																				<td>2</td>
																					<td style="width:500px;">
																				...
																				<td><input type="text" name="koreksi46"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																				<th rowspan="2">No.</th>
																			...
																			<tr>
																				...
																				<td><input type="text" name="koreksi47"></td>
																			</tr>
																			<tr>
																				<td>2</td>
																					<td style="width:500px;">
																				...
																				<td><input type="text" name="koreksi48"></td>
																			</tr>
																		</thead>
																</table>
																	...
																	<thead>
																			...
																			<tr>
																				<td style="width:500px;">
																					...
																					?>
																				</td><td><input type="text" name="koreksi49"></td>
																			</tr>
																			<tr>
																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi50"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi51"></td>
																			</tr>
																			<tr>
																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi52"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; color:#FFFFFF; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi53"></td>
																			</tr>
																			<tr>
																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi54"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; color:#FFFFFF; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi55"></td>
																			</tr>
																			<tr>
																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi56"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; color:#FFFFFF; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi57"></td>
																			</tr>
																			<tr>
																			<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi58"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; color:#FFFFFF; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi59"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi60"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; color:#FFFFFF; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi61"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi62"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; color:#FFFFFF; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi63"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi64"></td>
																			</tr>
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi65"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi66"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi67"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi68"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi69"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi70"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style=" background:#1a82c3; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi71"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi72"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi73"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi74"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi75"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi76"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi77"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi78"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi79"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi80"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;" rowspan="4"></th>
																				<th style="background:#1a82c3; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi81"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi82"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi83"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi84"></td>
																			</tr>
																			<tr>
																				<th rowspan="4" style="background:#eee; color:#FFFFFF;"></th>
																				<th style="background:#1a82c3; color:#FFFFFF; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi85"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi86"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi87"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi88"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi89"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi90"></td>
																			</tr>
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi91"></td>
																			</tr>
																			<tr>
																																				<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi92"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi93"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi94"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																				<th rowspan="4" style="background:#eee; color:#FFFFFF; width:80px;"></th>
																				<th style="width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi95"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name=koreksi96""></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																				<th rowspan="4" style="background:#eee; color:#FFFFFF; width:80px;"></th>
																				<th style="width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi97"></td>
																			</tr>
																		</thead>
																</table>
																...
																<table class="table table-bordered">
																	<thead>
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi98"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi99"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi100"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi101"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;"></th>
																				<th style="background:#1a82c3; color:#FFFFFF; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi102"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi103"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi104"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi105"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;"></th>
																				<th style="background:#1a82c3; color:#FFFFFF; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi106"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi107"></td>
																			</tr>
																			<tr style="background:#eee; color:#FFFFFF;">
																				<th style="width:80px;"></th>
																				<th style="background:#1a82c3; color:#FFFFFF; width:500px; text-align:left;" colspan="5" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi108"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi109"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi110"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi111"></td>
																			</tr>
																		</thead>
																</table>
																...
																<table class="table table-bordered">
																	<thead>
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi112"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi113"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi114"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi115"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi116"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi117"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi118"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi119"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi120"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi121"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																				<th rowspan="4" style="background:#eee; color:#FFFFFF; width:80px;"></th>
																				<th style="text-align:left;" colspan="4" class="uppercase">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi122"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi123"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi124"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi125"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi126"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi127"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi128"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi129"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi130"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi131"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi132"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi133"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi134"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi135"></td>
																			</tr>
																			<tr style="background:#1a82c3; color:#FFFFFF;">
																			...
																			<tr>
																					...
																					?>
																				</td><td><input type="text" name="koreksi136"></td>
																			</tr>
																			<tr>
																																					<td style="width:500px;">
																						<?php
																					...
																					?>
																				</td><td><input type="text" name="koreksi137"></td>
																			</tr>
																	...
																	<thead>
																			...
																			<tr>
																				<td>1.</td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi138"></td>
																			</tr>
																			<tr>
																				<td>2.</td>
																																					<td>
																					...
																					?>
																				</td><td><input type="text" name="koreksi139"></td>
																			</tr>
																		</thead>
																</table>
																	...
																	<thead>
																		...
																		<tr style="background:#1a82c3; color:#FFFFFF;">
																				...
																				<tr>
																						...
																						?>
																					</td><td><input type="text" name="koreksi140"></td>
																				</tr>
																				<tr>
																																						<td style="width:500px;">
																							<?php
																						...
																						?>
																					</td><td><input type="text" name="koreksi141"></td>
																				</tr>
																				<tr>
																																						<td style="width:500px;">
																							<?php
																						...
																						?>
																					</td><td><input type="text" name="koreksi142"></td>
																				</tr>
																				<tr>
																																						<td style="width:500px;">
																							<?php
																						...
																						?>
																					</td><td><input type="text" name="koreksi143"></td>
																				</tr>
																				<tr>
																																						<td style="width:500px;">
																							<?php
																						...
																						?>
																					</td><td><input type="text" name="koreksi144"></td>
																				</tr>
																				...
																				<tr>
																						...
																						?>
																					</td><td><input type="text" name="koreksi145"></td>
																				</tr>
																				<tr>
																																						<td style="width:500px;">
																							<?php
																						...
																						?>
																					</td><td><input type="text" name="koreksi146"></td>
																				</tr>
																				<tr>
																																						<td style="width:500px;">
																							<?php
																						...
																						?>
																					</td><td><input type="text" name="koreksi147"></td>
																				</tr>
																				<tr>
																																						<td style="width:500px;">
																							<?php
																						...
																						?>
																					</td><td><input type="text" name="koreksi148"></td>
																				</tr>
																				<tr>
																																						<td style="width:500px;">
																							<?php
																						...
																						?>
																					</td><td><input type="text" name="koreksi149"></td>
																				</tr>
																		</thead>
																	</table>
																	...
																	<thead>
																		...
																		<tr style="background:#1a82c3; color:#FFFFFF;">
																				...
																				<tr>
																						...
																						?>
																					</td><td><input type="text" name="koreksi150"></td>
																				</tr>
																				...
																				<tr>
																						...
																						?>
																					</td><td><input type="text" name="koreksi151"></td>
																				</tr>
																		</thead>
																</table>
