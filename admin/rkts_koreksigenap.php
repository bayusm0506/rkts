				...
				?>
					<tbody>
							...
							<tr class="gradeA">
								...
								<td><div  class="btn btn-round btn-success">
								<a style="color:white;" href="ekts.php?semester=<?php echo $row[semester];?>&tahun_ajaran=<?php echo $row[tahun_ajaran];?>&nik=<?php echo $row[nik];?>">Lengkapi EKTS</a>
								</div></td>
